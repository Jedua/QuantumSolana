...
async def main_loop(db, ia, exp, risk_manager):
    ...
    log_terminal_event("INFO", "SYSTEM_START", "Iniciando simulacion SOL.", PAPER_TERMINAL_LOG_FILE)
    ...
    async with websockets.connect(url, ping_interval=None) as ws:
        print(f"{Fore.GREEN}[ONLINE] Simulador SOL Activo. Desconectado de tu dinero real.")
        ...
        while True:
            try:
                ...
                # Usamos el vol_total del top of book como proxy de volumen tick-a-tick
